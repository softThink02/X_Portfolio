...
export const PinPerspective = ({
  ...
  return (
    <motion.div className="pointer-events-none w-full h-full border-blue-600 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
