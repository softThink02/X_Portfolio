  ...
  return (
    <div className="flex flex-col items-center justify-center px-4">
      ...
      <div className="flex items-center justify-center py-2 gap-4">
        ...
        <div
          className={`flex items-center justify-center bg-black-200 text-green-700 h-[60px] rounded-full relative overflow-hidden w-[230px]`}
        >
          <AnimatePresence mode="wait">
            {showText ? (
              <FooterHeader variant="heroDiv" className="absolute inset-0 flex text-[14px] items-center justify-center">
